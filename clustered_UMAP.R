plot_umap_with_clusters <- function(
    umap_csv = "umap_out.csv",
    labels_csv = "leiden_export_labels.csv"
) {
  # Load packages
...
source("plot_umap_with_clusters.R")  # if you saved the function here
